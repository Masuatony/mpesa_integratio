package org.integation.mpesaapp.Configurations;
...
public class MpesaConfigs {
    ...
    public String toString() {
        return String.format("{consumerKey='%s', consumerSecret='%s', grantType='%s', oauthEndpoint='%s'}",consumerKey,
                consumerSecret,grantType,oauthEndpoint);
    }
